...
router.post('/', authMiddleware, vendorMiddleware, menuItemsController.createMenuItem);

// PATCH route - only vendors can update
router.patch('/:id', authMiddleware, vendorMiddleware, menuItemsController.updateMenuItem);

// DELETE route - only vendors can delete
router.delete('/:id', authMiddleware, vendorMiddleware, menuItemsController.deleteMenuItem);
