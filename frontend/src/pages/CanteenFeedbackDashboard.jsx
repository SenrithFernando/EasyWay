...
export function CanteenFeedbackDashboard() {
  ...
  useEffect(() => {
    const loadDashboard = async () => {
      ...
      try {
        const response = await feedbackApi.getVendorDashboard(vendorId, 6);
          ...
          <div className="relative grid gap-8 xl:grid-cols-[1.15fr_0.85fr]">
            <div>
              ...
              <h1 className="mt-5 max-w-2xl text-3xl font-bold tracking-tight sm:text-5xl">
                Your vendor's reputation, plated as a live story.
              </h1>
                    ...
                    >
                      ...
                      <div className="mt-6">
                        ...
                        <div className="h-3 rounded-full bg-white/80">
                          <div
                            className={`h-3 rounded-full ${label === 'Positive'
                                ? 'bg-emerald-500'
                                : label === 'Negative'
                                  ? 'bg-orange-500'
                                  : 'bg-slate-500'
            ...
            <Card className="border-none bg-[linear-gradient(180deg,_#ffffff_0%,_#f8fafc_100%)] shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
              <div className="mb-6 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                ...
                <p className="max-w-xl text-sm leading-6 text-surface-500">
                  ...
                  worth reinforcing across your vendor team.
                </p>
              </div>
              ...
              <div className="grid gap-4 xl:grid-cols-3">
                {dashboard.latestReviews.map((review, index) => (
                  <article
                    ...
                    className={`rounded-[1.75rem] border p-5 transition duration-300 hover:-translate-y-1 ${index === 0
